...
public class Constants {
    ...
    // API URLs
    public static final String TEMPERATURE_URL = "https://query.yahooapis.com/v1/public/yql";
    ...
    //API Keys
    public static final String NEWS_API_KEY = "6a0ac44ebf0d41f58237173d810c6d16";
